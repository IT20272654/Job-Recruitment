    ...
    <div className="lg:px-12 px-4">
      <div className="mb-20 text-center">
        <p className="text-xl text-headingcolor font-semibold mb-5">
          Do you wanna further more information...?
        </p>
        <h2 className="md:text-5xl text-4xl text-headingcolor font-bold">
          Just Contact us
        </h2>
        <p className="mt-5">
        Have questions or need assistance? We're here to help! Contact our friendly team today for personalized support and guidance.{" "}
        </p>
      </div>
